...
- IMPL-0003 Phase 7 (minimal `/search` route consuming `<Snippet>`) onwards. The route map will gain a `search.tsx` route and the directory page header will get a "Search" link.

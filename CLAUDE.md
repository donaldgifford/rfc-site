...
## Repo layout (current — through Phase 3)
...
docs/
  ...
  impl/                              ← IMPL-0001..0004 closed; IMPL-0005 Phase 0/1/2/3 done
...
src/
  ...
  components/
    Topbar/                          ← Brand + search trigger + ⌘K + nav placeholders + SearchModal mount (7 tests)
...
Phase 0 / 1 / 2 / 3 are closed. Phase 4a (`/mcp` shell) is the next IMPL-0005 slice — see [IMPL-0005 §Phase 4a](docs/impl/0005-execute-the-rfc-site-rebuild-per-design-0003.md).

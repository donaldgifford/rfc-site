...
- IMPL-0003 Phase 6 (`<Snippet>` for `SearchResult.snippet`) and Phase 7 (minimal `/search` route) onwards. The route map will gain a `search.tsx` route and the directory page header will get a "Search" link.
